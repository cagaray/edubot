...
TEST_DATASET_PATH = '/research/edubot/seq2seq_edubot/tf_seq2seq_chatbot/data/test/test_set.txt'
SAVE_DATA_DIR = '/research/edubot/seq2seq_edubot/var/lib/tf_seq2seq_chatbot/'
